...
export default function Awards() {
  return (
    <div className="min-h-screen bg-gradient-to-r from-teal-500 via-indigo-500 to-purple-600 text-white p-8">
      {/* タイトル */}
      <motion.div
            ...
            <ul className="space-y-4">
              {award.items.map((item, idx) => (
                <li key={idx} className="border-l-4 border-teal-500 pl-4">
                  ...
                  <p className="text-lg text-gray-700 mt-1">{item.recipient}</p>
                </li>
              ))}
            </ul>
          </motion.div>
